...
def test_qwen_pipeline_parallel_sft_example_compiles():
    subprocess.run(
        [
            sys.executable,
            "-m",
            "py_compile",
            "modal_apps/qwen_pipeline_parallel_sft/sft.py",
        ],
        check=True,
    )


def test_qwen_large_model_parallel_sft_example_compiles():
    subprocess.run(
        [
            sys.executable,
            "-m",
            "py_compile",
            "modal_apps/qwen_large_model_parallel_sft/sft.py",
        ],
        check=True,
    )
